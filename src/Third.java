...
public class Third extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        try {
            ...
            stat.execute("UPDATE Notebooks SET CpuFreq = CpuFreq + 1 WHERE CpuName = 'Intel'");
            PreparedStatement statement = con.prepareStatement("Select * from Notebooks WHERE CpuName = 'Intel'");
