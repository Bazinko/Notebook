...
public class First extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        try {
            ...
            PreparedStatement statement = con.prepareStatement("Select * from Notebooks WHERE HardDriveCapacity is null " +
                    "AND RamCapacity = 4 AND GraphicCardCapacity = 1 AND CpuName = 'AMD'");
